...
//
//今回:rawcsvフォルダのdailyデータから，ザラバにおいて最良買い気配値が最良売り気配値とが等しい(=の関係)場合のデータを抽出する．
public class bid_equal_to_ask {

	public static void main(String[] args) throws IOException {

		String currentdir = "C:\\Users\\kklab\\Desktop\\yurispace\\plate_fluctuation\\src\\nikkei_needs_output";
		String datayear = "\\2008";
		String datadir = "\\rawcsv_2\\daily";
		String writedir = "\\bid_equal_to_ask_from_rawcsv_2"; // エラーを発見したときのみファイルを作成
