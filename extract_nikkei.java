...
public class extract_nikkei{
    ...
    public static void main(String[] args) throws IOException{
		...
		String datadir = "\\nikkei_needs_data";
        BufferedReader br = new BufferedReader(new FileReader(currentdir + datadir + "\\filelist.txt"));//読み込むファイル名のリストを取得
        String txtFileName;
        ...
        while((txtFileName = br.readLine()) != null) {
        	...
        	FileReader fr = new FileReader("G:\\日経平均先物\\2014\\" + txtFileName);//txtFileName);
            ...
            System.out.println(filename[1]);
         	...
         	File file = new File(currentdir + "\\nikkei_needs_output\\" + "\\raw\\" + filename[1] + "_" + filename[2] + "_.txt" );
